  ...
  $.fn.richText = function (options) {
    ...
    if(typeof options !== 'undefined'){
      if(options.data && typeof options.data !== 'undefined'){
        $inputElement[0].innerHTML = options.data;
        document.getElementById("editor2").value = options.data;
      }
    }
    ...
    var $editor,
      ...
      $toolbarElement = $("<li />"),
      $btnBold = $("<a />", {
        class: "richText-btn fa fa-bold",
        "data-command": "bold",
      }), // bold
      $btnItalic = $("<a />", {
        class: "richText-btn fa fa-italic",
        "data-command": "italic",
      }), // italic
      $btnUnderline = $("<a />", {
        class: "richText-btn fa fa-underline",
        "data-command": "underline",
      }), // underline
      $btnLeftAlign = $("<a />", {
        class: "richText-btn fa fa-align-left",
        "data-command": "justifyLeft",
      }), // left align
      $btnCenterAlign = $("<a />", {
        class: "richText-btn fa fa-align-center",
        "data-command": "justifyCenter",
      }), // centered
      $btnRightAlign = $("<a />", {
        class: "richText-btn fa fa-align-right",
        "data-command": "justifyRight",
      }), // right align
      $btnOL = $("<a />", {
        class: "richText-btn fa fa-list-ol",
        "data-command": "insertOrderedList",
      }), // ordered list
      $btnUL = $("<a />", {
        class: "richText-btn fa fa-list",
      ...
      $btnRemoveStyles = $("<a />", {
        class: "richText-btn fa fa-recycle",
        "data-command": "removeFormat",
      }), // clean up styles
      $btnCode = $("<a />", {
        class: "richText-btn fa fa-code",
    ...
    var $dropdownList = $("<ul />", { class: "richText-dropdown" }), // dropdown lists
      ...
      $formButton = $("<button />", { text: "Save", class: "btn btn-primary" }); // button
    ...
    $titles.append(
      $("<li />", {
        html: '<a data-command="formatBlock" data-option="h1">Title #1</a>',
      })
    );
    $titles.append(
      $("<li />", {
        html: '<a data-command="formatBlock" data-option="h2">Title #2</a>',
      })
    );
    $titles.append(
      $("<li />", {
        html: '<a data-command="formatBlock" data-option="h3">Title #3</a>',
      })
    );
    $titles.append(
      $("<li />", {
        html: '<a data-command="formatBlock" data-option="h4">Title #4</a>',
      })
    );
    ...
    $(document).on(
      "keyup keydown change blur paste copy cut",
      ".richText-editor",
      function () {
        __updateTextarea();
        doSave();
    ...
    $(document).on(
      "keyup keydown blur paste copy cut",
      ".richText-initial",
      function () {
        __updateEditor();
        doSave();
    ...
    $(document).on(
      "click",
      ".richText-toolbar a[data-command]",
      function (event) {
        var $button = $(this);
        var $toolbar = $button.closest(".richText-toolbar");
        if (
          $toolbar.siblings("#" + editorID).length > 0 &&
    ...
    function __formatText(command, option) {
      ...
      if (command === "heading" && __getSelectedText()) {
        // IE workaround
        __pasteHtmlAtCaret(
          "<" + option + ">" + __getSelectedText() + "</" + option + ">"
        );
      } else {
